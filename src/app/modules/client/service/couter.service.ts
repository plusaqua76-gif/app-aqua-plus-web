...
export class CounterService {
  ...
  deleteAforoContador(idAforoContador: number): Observable<ApiResponse<any>> {
    return this.http.delete<ApiResponse<any>>(`${this.apiUrl}/aforo-contador/${idAforoContador}`);
  }
