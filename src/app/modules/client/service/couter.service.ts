...
export class CounterService {
  ...
  deleteAforoContador(idContador: number, idAforo: number): Observable<ApiResponse<any>> {
    return this.http.delete<ApiResponse<any>>(`${this.apiUrl}/aforo-contador/${idContador}/${idAforo}`);
  }
