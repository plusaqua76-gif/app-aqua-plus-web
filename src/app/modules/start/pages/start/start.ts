...
@Component({
  ...
  styles: [`
    ...
    :host ::ng-deep .dashboard-slot:not(.slot-bar-chart) > * > div:first-child {
      height: 100%;
    }
  ...
  template: `
    <div class="min-h-screen w-full p-4 md:p-6 grid gap-4 md:gap-6">
      ...
      <div class="dashboard-grid">
        ...
        <div class="dashboard-slot slot-pass-customers">
      ...
      <div class="rounded-xl border border-white/10 bg-white/20 dark:bg-slate-800/20 backdrop-blur-xl shadow-sm overflow-hidden">
