        ...
        >
          ...
          >
            <a class="text-amber-100 hover:opacity-80 transition" href="#nosotros"
              >Nosotros</a
            >
            <a class="text-amber-100 hover:opacity-80 transition" href="#galeria"
              >Galería</a
            >
            <a class="text-amber-100 hover:opacity-80 transition" href="#soluciones"
              >Soluciones</a
            >
            <a class="text-amber-100 hover:opacity-80 transition" href="#contactanos"
              >Contáctanos</a
            >
          </nav>
            ...
            >
              <a
                ...
                class="btn !w-[170px] max-lg:!w-[160px] !rounded-xl !py-4 max-lg:!py-2 flex gap-2 group !bg-transparent !text-black dark:!text-white transition-colors
                                        duration-[0.3s] border-[1px] border-black dark:border-white hover:bg-green-500 hover:border-green-500 hover:text-white"
              >
                <div
                ...
                >
                  ...
                  ></div>
                  <svg
                    class="w-6 h-6 text-black dark:text-white group-hover:text-white"
                    fill="currentColor"
                    viewBox="0 0 24 24"
    ...
    @defer (on viewport) {
      ...
      >
        ...
        >
          ...
          <div
            class="mt-8 relative gap-8 p-4 grid place-items-center
                   grid-cols-1 md:grid-cols-2 xl:grid-cols-3
                   max-w-7xl mx-auto"
          >
            <div
              class="reveal-up w-full max-w-[350px] border-[1px] h-[400px] rounded-md place-items-center p-4
            ...
            <div
              class="reveal-up w-full max-w-[350px] border-[1px] h-[400px] rounded-lg place-items-center p-4
                     bg-[#f2f3f4] dark:bg-[#141414] dark:border-[#1f2123] flex flex-col gap-3
                     hover:shadow-lg transition-shadow duration-300"
            >
              <div
