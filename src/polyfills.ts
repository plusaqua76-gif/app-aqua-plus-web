 ...
 * (window as any).__Zone_disable_unhandledPromiseRejection = true; // disable patch unhandledPromiseRejection
 * (window as any).__Zone_disable_timer = true; // disable patch timer
